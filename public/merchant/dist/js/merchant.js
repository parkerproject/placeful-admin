...
function checkEmail() {
    ...
    businessObj.business_hashtags = $('input[name=business_hashtags]').val()
    ...
    if (businessObj.business_hashtags === '') {
        $('.error').text('Enter labels for business')
    }
